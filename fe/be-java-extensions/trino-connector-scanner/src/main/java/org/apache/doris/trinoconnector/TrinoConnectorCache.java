...
public class TrinoConnectorCache {
    ...
    private static TrinoConnectorCacheValue loadCache(TrinoConnectorCacheKey key) {
        try {
            ...
            Connector connector = trinoConnectorServicesProvider.getConnectorServices(key.catalogHandle).getConnector();
            return new TrinoConnectorCacheValue(connector, handleResolver, trinoConnectorServicesProvider);
        } catch (Exception e) {
    ...
    public static class TrinoConnectorCacheKey {
        ...
        public void setCatalogHandle(CatalogHandle catalogHandle) {
