...
public class TrinoConnectorJniScanner extends JniScanner {
    ...
    public TrinoConnectorJniScanner(int batchSize, Map<String, String> params, PluginLoader pluginLoader) {
        ...
        String catalogName = params.get("catalog_name");
        catalogHandle = CatalogHandle.createRootCatalogHandle(catalogName, new CatalogVersion("test"));
    ...
    protected int getNext() throws IOException {
        ...
        LOG.info("--ftw: BE getNext: get source cost: " + (endTime - startTime) + " ms");
        ...
        LOG.info("--ftw: BE getNext get page cost: " + (endTime - startTime) + " ms, rows = " + rows);
        return rows;
    }
    ...
    private void initTable() {
        try {
            ...
            long endTime = System.currentTimeMillis();
            LOG.info("--ftw: BE decodeStringToObject cost: " + (endTime - startTime) + " ms");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void initConnector() {
        ...
        TrinoConnectorCacheKey cacheKey = new TrinoConnectorCacheKey(catalogHandle.getCatalogName(), connectorName);
        ...
        cacheKey.setCatalogHandle(this.catalogHandle);
