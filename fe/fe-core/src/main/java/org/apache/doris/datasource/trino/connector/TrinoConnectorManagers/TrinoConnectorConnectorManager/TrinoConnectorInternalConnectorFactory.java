...
public class TrinoConnectorInternalConnectorFactory {
    private final ConnectorFactory connectorFactory;
    private final Function<CatalogName, ClassLoader> duplicatePluginClassLoaderFactory;

    public TrinoConnectorInternalConnectorFactory(ConnectorFactory connectorFactory, Function<CatalogName, ClassLoader> duplicatePluginClassLoaderFactory) {
